...
var passwordFormatValue = function (value) {
    return null;
};
...
exports.multipleCheckbox = function (opt) {
    ...
    w.toHTML = function (name, f) {
        ...
        return Object.keys(f.choices).reduce(function (html, k) {
            ...
            var checked = f.value && (Array.isArray(f.value) ? f.value.some(function (v) {
                    return String(v) === String(k);
                }) : String(f.value) === String(k));
...
exports.multipleSelect = function (opt) {
    ...
    w.toHTML = function (name, f) {
        ...
        var optionsHTML = Object.keys(f.choices).reduce(function (html, k) {
            var selected = f.value && (Array.isArray(f.value) ? f.value.some(function (v) {
                    return String(v) === String(k);
                }) : String(f.value) === String(k));
            return html + tag('option', {
                    value: k,
