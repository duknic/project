...
module.exports.getUser = function (req, res, next) {
    ...
    if (req.stormpathSession && req.stormpathSession.user) {

        req.app.get('stormpathClient').getAccount(req.stormpathSession.user, function (err, account) {
            if (err) {
            ...
            module.exports.expandAccount(req.app, account, function (err, expandedAccount) {
                ...
                req.stormpathSession.user = expandedAccount.href;
